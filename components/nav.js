...
export default function Nav() {
    ...
    useEffect(() => {
        ...
        if (x.className === "w-full lg:flex flex-grow lg:items-center lg:w-auto hidden lg:block") {
            x.className = "w-full lg:flex flex-grow lg:items-center lg:w-auto lg:block"
        } else {
            x.className = "w-full lg:flex flex-grow lg:items-center lg:w-auto hidden lg:block"
        }
    })
    return (
